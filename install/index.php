<h3>TsubasaServer Installation</h3><hr />
<?php
...
if(isset($_REQUEST["step"])){
  switch($_REQUEST["step"]){
      case 1:{
          ...
          <li>If you don\'t know which port is your database server using, write 3306.</li>
          </ul>
          </p>
          ';
          echo '
      ...
      ");
      $conn->query("
      CREATE PROCEDURE RETRIEVE_WELCOME_MESSAGE()
        SELECT WelcomeMessage FROM Configurations
      ");
      $conn->query("
      CREATE PROCEDURE MODIFY_WELCOME_MESSAGE(IN newWelcomeMessage TEXT)
      UPDATE Configurations SET Configurations.WelcomeMessage = newWelcomeMessage
      ");
      echo 'done.<br />';
      echo '
      ...
      ';
      echo '
      Now it should be all set. Click <a href="../index.php">here</a> to visit your new server.<br />
    ...
    if(file_exists("../config.php")){
        echo '
        Seems that you\'ve already installed TsubasaServer.
        Click <a href="../index.php">here</a> to go back.
        ';
    } else {
        echo '
        Seems that you haven\'t installed TsubasaServer yet.<br />
